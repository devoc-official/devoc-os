...
export const CANONICAL_EVENT_CATALOG: Array<{
  ...
  // M15 Workforce Time, Attendance & Leave Engine
  { eventName: 'workforce.schedule.created', version: '1.0', sourceModule: 'workforce-time', description: 'Workforce schedule template created' },
  { eventName: 'workforce.schedule.updated', version: '1.0', sourceModule: 'workforce-time', description: 'Workforce schedule template updated' },
  { eventName: 'workforce.schedule_assignment.created', version: '1.0', sourceModule: 'workforce-time', description: 'Schedule assigned to employment' },
  { eventName: 'workforce.schedule_assignment.updated', version: '1.0', sourceModule: 'workforce-time', description: 'Schedule assignment updated' },
  { eventName: 'attendance.record.created', version: '1.0', sourceModule: 'workforce-time', description: 'Daily attendance record created' },
  { eventName: 'attendance.record.updated', version: '1.0', sourceModule: 'workforce-time', description: 'Daily attendance record updated' },
  { eventName: 'attendance.session.checkin', version: '1.0', sourceModule: 'workforce-time', description: 'Attendance check-in clocked' },
  { eventName: 'attendance.session.checkout', version: '1.0', sourceModule: 'workforce-time', description: 'Attendance check-out clocked' },
  { eventName: 'attendance.correction.requested', version: '1.0', sourceModule: 'workforce-time', description: 'Attendance correction requested' },
  { eventName: 'attendance.correction.approved', version: '1.0', sourceModule: 'workforce-time', description: 'Attendance correction approved' },
  { eventName: 'attendance.correction.rejected', version: '1.0', sourceModule: 'workforce-time', description: 'Attendance correction rejected' },
  { eventName: 'workforce.time.started', version: '1.0', sourceModule: 'workforce-time', description: 'Workforce time interval started' },
  { eventName: 'workforce.time.completed', version: '1.0', sourceModule: 'workforce-time', description: 'Workforce time interval completed' },
  { eventName: 'workforce.time.updated', version: '1.0', sourceModule: 'workforce-time', description: 'Workforce time record updated' },
  { eventName: 'timesheet.created', version: '1.0', sourceModule: 'workforce-time', description: 'Timesheet period created' },
  { eventName: 'timesheet.submitted', version: '1.0', sourceModule: 'workforce-time', description: 'Timesheet submitted for review' },
  { eventName: 'timesheet.approved', version: '1.0', sourceModule: 'workforce-time', description: 'Timesheet approved and locked' },
  { eventName: 'timesheet.rejected', version: '1.0', sourceModule: 'workforce-time', description: 'Timesheet rejected' },
  { eventName: 'timesheet.cancelled', version: '1.0', sourceModule: 'workforce-time', description: 'Timesheet cancelled' },
  { eventName: 'leave.type.created', version: '1.0', sourceModule: 'workforce-time', description: 'Leave type configured' },
  { eventName: 'leave.policy.created', version: '1.0', sourceModule: 'workforce-time', description: 'Leave policy configured' },
  { eventName: 'leave.balance.updated', version: '1.0', sourceModule: 'workforce-time', description: 'Leave balance adjusted or mutated' },
  { eventName: 'leave.request.created', version: '1.0', sourceModule: 'workforce-time', description: 'Leave request created' },
  { eventName: 'leave.request.submitted', version: '1.0', sourceModule: 'workforce-time', description: 'Leave request submitted and balance reserved' },
  { eventName: 'leave.request.approved', version: '1.0', sourceModule: 'workforce-time', description: 'Leave request approved and balance committed' },
  { eventName: 'leave.request.rejected', version: '1.0', sourceModule: 'workforce-time', description: 'Leave request rejected and balance released' },
  { eventName: 'leave.request.cancelled', version: '1.0', sourceModule: 'workforce-time', description: 'Leave request cancelled and balance released' },
  { eventName: 'holiday.created', version: '1.0', sourceModule: 'workforce-time', description: 'Workforce holiday scheduled' },
  { eventName: 'holiday.updated', version: '1.0', sourceModule: 'workforce-time', description: 'Workforce holiday updated' },
];
